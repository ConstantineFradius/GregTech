...
public class Materials {
    ...
    public static Material BandedIron = new Material(Ref.ID, "banded_iron", 0x915a5a, DULL).asDust(ORE).add(Iron, 2, Oxygen, 3);
    ...
    public static Material GraniteQuartz = new Material(Ref.ID, "white_granite", 0xededed, ROUGH).asDust().addTools(4.0F, 64, 3).add(Silicon, 1, Oxygen, 2);
    ...
    public static Material Hornfels = new Material(Ref.ID, "hornfls", 0x64460a, NONE).asDust();        
