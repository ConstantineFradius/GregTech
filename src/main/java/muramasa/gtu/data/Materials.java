...
public class Materials {
    ...
    public static Material Fluorine = new Material(Ref.ID, "fluorine", 0xf7e68d, NONE, F).asGas();
    ...
    public static Material Chlorine = new Material(Ref.ID, "chlorine", 0xfff4cf, NONE, Cr).asGas();
    public static Material Argon = new Material(Ref.ID, "argon", 0xdd00ff, NONE, Ar).asGas();
    ...
    public static Material Gallium = new Material(Ref.ID, "gallium", 0xf2fdff, SHINY, Ga).asMetal(302, ORE);
    public static Material Germanium = new Material(Ref.ID, "germanium", 0xe6e6e6, SHINY, Ge).asMetal(1211, ORE);
    public static Material Arsenic = new Material(Ref.ID, "arsenic", 0x6b6b6b, DULL, As).asSolid(887);
    ...
    public static Material Niobium = new Material(Ref.ID, "niobium", 0x7c9dd6, METALLIC, Nb).asMetal(2750, 2750);
    ...
    public static Material Antimony = new Material(Ref.ID, "antimony", 0x97999c, SHINY, Sb).asMetal(1449, 0);
    public static Material Tellurium = new Material(Ref.ID, "tellrium", 0xafb0b3, SHINY, Te).asMetal(1261, 0);
    public static Material Iodine = new Material(Ref.ID, "iodine", 0x9797a1, SHINY, I).asDull(457);
    public static Material Xenon = new Material(Ref.ID, "Xenon", 0x3b89ff, NONE, Xe).asGas();
    public static Material Caesium = new Material(Ref.ID, "caesium", 0xdbd6af, METALLIC, Cs).asMetal(2349);
    public static Material Barium = new Material(Ref.ID, "barium", 0xbfbdae, METALLIC, Ba).asDust(1000);
    public static Material Lanthanum = new Material(Ref.ID, "lanthanum", 0xdbdbd5, METALLIC, La).asSolid(1193;
    public static Material Cerium = new Material(Ref.ID, "cerium", 0xedede8, METALLIC, Ce).asSolid(1068);
    ...
    public static Material Europium = new Material(Ref.ID, "europium", 0xfaf8f5, METALLIC, Eu).asMetal(1099, 1099);  
    ...
    public static Material Dysprosium = new Material(Ref.ID, "dysprosium", 0xfaf8f5, METALLIC, D).asMetal(1680, 1680);                                                                                                     
    ...
    public static Material Muscovite = new Material(Ref.ID, "muscovite", 0xf7fcfc, FINE).asDust().add(Potassium, 1, Aluminium, 3, Silicon, 3, Oxygen, 12, Oxygen, 12, Flourine, 1, Hydrogen, 2);
    public static Material Fuchsite = new Material(Ref.ID, "fuchsite", 0x7bdbc2, FINE).asDust().add(Potassium, 1, Aluminium, 2, Chromium, 1, Silicon, 3, Oxygen, 12, Oxygen, 12, Flourine, 1, Hydrogen, 2);
    ...
    public static Material Corundum = new Material(Ref.ID, "corundum", 0xc3d2e0, GEM_V).asDust(true, ORE, ORE_SMALL).add(Aluminium, 2, Oxygen, 3);
    ...
    public static Material Moissanite = new Material(Ref.ID, "moissanite", 0xebe7e6, GEM_V).asDust(true, ORE, ORE_SMALLrue, ORE, ORE_SMALL).add(Arsenic, 2, sulfur).add(Silicon, 1, Carbon, 3);
    public static Material Turquoise = new Material(Ref.ID, "turquoise", 0x77ecf2, GEM_V).asDust(true, ORE, ORE_SMALLrue, ORE, ORE_SMALL).add(Copper, 1, Aluminium, 6, Water, 12, Potassium, 4, Oxygen, 24, Hydrogen, 8,);
    ...
    public static Material Tourmaline = new Material(Ref.ID, "tourmaline", 0x030201, GEM_V).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 2).add(Lithium, 1, Manganese, 1, Magnesium, 2, Aluminium, 4, Iron 2, Chromium, 1, Vanadium, 1 Silicon, 2, Boron, 5, Oxygen, 29, Hydrogen, 2, Flourine, 1);   12);
    ...
    public static Material ChromeChalcedony = new Material(Ref.ID, "chrome_chalcedony", 0x639968, GEM_V).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 2).add(Silicon, 1, Oxygen, 2);  
    ...
    public static Material GemHematite = new Material(Ref.ID, "gem_hematite", 0x080602, FINE).asDust().add(Iron, 2, Oxygen, 3);        //iron carvings are nice, this is technically the same thing as banded iron                                                                                             
    ...
    public static Material Bertrandite = new Material(Ref.ID, "bertrandite", 0xfafaed, FINE).asDust().add(Beryllium, 4, Silicon, 2, Oxygen, 9, Hydgrogen, 2);
    ...
    public static Material Jade = new Material(Ref.ID, "jade", 0x57ba7f, GEM_V).asGem(true, ORE, ORE_SMALL).addTools(9.0F, 590, 3).add(Sodium, 2, Aluminium, 1, Iron, 1, Silicon, 4, Oxygen 8);
    ...
    public static Material CalciumSulfate = new Material(Ref.ID, "calcium_sulfate", 0xf5f7f5, FINE).asDust().add(Calcium, 1, Sulfur, 1, Oxygen, 4);
    ...
    public static Material Yellow_Zircon = new Material(Ref.ID, "yellow_zircon", 0xfff5ba, QUARTZ).asDust().add(Zirconium, 10, Silicon, 10, Oxygen, 40, Hafnium, 1, Pitchblende, 1);
    ...
    public static Material Chalcocite = new Material(Ref.ID, "siderite", 0x918f4e, Dull).asDust().add(Iron, 1, Carbon, 1, Oxygen, 3);
    ...
    public static Material Carborundum = new Material(Ref.ID, "carborundum", 0x827f7f, METALLIC).asDust(ORE, ORE_SMALL).add(Silicon, 1, Carbon, 1);
    ...
    public static Material Boronic Acid = new Material(Ref.ID, "boronic_acid", 0xe3dccf, METALLIC).asDust(ORE, ORE_SMALL).add(Boron, 1, Oxygen, 3, Hydrogen, 3); 
    ...
    public static Material Gadolinite = new Material(Ref.ID, "gadolinite", 0x666564, METALLIC).asDust(ORE, ORE_SMALL).add(Neodymium, 1, Yttrium, 1, Lantanum, 1, Cerium, 1 Berylium, 4, Iron, 2, Silicon , 4, Oxygen, 10);
    public static Material Euxenite = new Material(Ref.ID, "euxenite", 0xebbfa4, METALLIC).asDust(ORE, ORE_SMALL).add(Yttrium, 1, Calcium, 1, Cerium, 1, Uranium, 1, Thorium, 1, Niobium, 1 , Tantalum, 1, Oxygen, 12);
    ...
    public static Material Skutterudite = new Material(Ref.ID, "skutterudite", 0xbdb8b7, METALLIC).asDust(ORE, ORE_SMALL).add(Cobalt, 1, Arsenic, 3);
    ...
    public static Material Kruitaite = new Material(Ref.ID, "kruitaite", 0xada52d, METALLIC).asDust(ORE, ORE_SMALL).add(Copper, 1, Selenium, 2);
    ...
    public static Material Pollucite = new Material(Ref.ID, "pollucite", 0xc9d4b6, METALLIC).asDust(ORE, ORE_SMALL).add(Caesium, 1, Silicon,2, Aluminum, 1, Oxygen, 6, Water, 6);
    ...
    public static Material Dzhalindite = new Material(Ref.ID, " dzhalindite", 0xd4d1c7, METALLIC).asDust(ORE, ORE_SMALL).add(Indium, 1, Oxygen, 3, Hydrogen);
    ...
    public static Material RareEarth = new Material(Ref.ID, "rareearth", 0xb8b8b8, METALLIC).asDust(ORE, ORE_SMALL).add(Lanthanum, 7, Neodymium, 7, Samarium, 2, Cerium, 13, Yttrium, 6, Scandium, 5, Neodymium, 7, Samarium, 3, Europium, 1, Gadlinium, 1, Terbium, 1, Dysprosium, 1, Holmium, 1, Erbium, 1, Thulium, 1, Ytterbium, 1, Lutetium, 1, Hafnium, 1);  
  ...
  /** Gems **/
    ...
    public static Material GraniteYellow = new Material(Ref.ID, "yellow_granite", 0xf5ed82, ROUGH).asDust().addTools(4.0F, 64, 3).add(SiliconDioxide, 4, Muscovite, 1);
    public static Material GraniteGreen = new Material(Ref.ID, "green_granite", 0x88b54e, ROUGH).asDust().addTools(4.0F, 64, 3).add(SiliconDioxide, 4, Ampibole, 1);
    //Marble
    public static Material Marble = new Material(Ref.ID, "marble", 0xc8c8c8, NONE).asDust().add(Magnesium, 1, Calcite, 7);
    public static Material Green_Marble = new Material(Ref.ID, "green_marble", 0xb3cf8f, NONE).asDust().add(Magnesium, 1, Calcite, 7, Serpentine, 2);
    public static Material Black_Marble = new Material(Ref.ID, "black_marble", 0x1f211c, NONE).asDust().add(Magnesium, 1, Calcite, 7, Coal, 1, Lignite, 3);
    public static Material Pink_Marble = new Material(Ref.ID, "pink_marble", 0xd9bfe0, NONE).asDust().add(Magnesium, 1, Calcite, 7, BandedIron, 1,);
    public static Material Red_Marble = new Material(Ref.ID, "red_marble", 0xe05431, NONE).asDust().add(Magnesium, 1, Calcite, 7, BandedIron, 3,);
    //Basalt
    ...
    public static Material Tan_Basalt = new Material(Ref.ID, "tan_basalt", 0xd9c1ad, ROUGH).asDust().add(Olivine, 1, Calcite, 3, Flint, 8, DarkAsh, 4, SodiumPlagioclase, 3, CalciumPlagioclase, 3); //Tannish White Basalt                                                                                                    
    public static Material Gabbro = new Material(Ref.ID, "gabbro", 0x1f1a17, ROUGH).asDust().add(Olivine, 1, Calcite, 3, Flint, 8, DarkAsh, 4, SodiumPlagioclase, 3, CalciumPlagioclase, 3); //Gabbro 
    public static Material Peridotite = new Material(Ref.ID, "peridotite", 0x709665, ROUGH).asDust().add(Olivine, 5, Calcite, 1, Flint, 2, DarkAsh, 2,  CalciumPlagioclase, 1, SodiumPlagioclase, 1, Chromite, 1, GarnetSand, 1, Pyroxene, 5); 
    ...
    //Schist
    public static Material GreenSchist = new Material(Ref.ID, "green_schist", 0xaaf097, NONE).asDust(); //Serpentine, Muscovite,
    public static Material BlueSchist = new Material(Ref.ID, "blue_schist", 0x99b1e8, NONE).asDust(); //Basalt
    public static Material RedSchist = new Material(Ref.ID, "red_schist", 0xcc846c, NONE).asDust();
    public static Material ZebraSchist = new Material(Ref.ID, "zebra_schist", 0x828387, NONE).asDust();
    public static Material Soapstone = new Material(Ref.ID, "soapstone", 0xe8ede6, DULL).asDust(ORE).add(Magnesium, 3, Silicon, 4, Hydrogen, 2, Oxygen, 12); //TODO: Ore Gen                                                                                              
    //Soapstone should generate as a stone here and not an ore
    //Prismarine (Raw Natural Prismarine)
    public static Material Prismarine = new Material(Ref.ID, "prismarine", 0x49a3a2, NONE).asDust();                                                                                                     
    public static Material Dark_Prismarine = new Material(Ref.ID, "dark_prismarine", 0x69be69, NONE).asDust();     
    public static Material Red_Prismarine = new Material(Ref.ID, "red_prismarine", 0x3d5928, NONE).asDust();  (blood red block  thats very hard in nether)
    public static Material Elder_Prismarine = new Material(Ref.ID, "elder_prismarine", 0xe0d9c8, NONE).asDust();  
    public static Material Black_Prismarine = new Material(Ref.ID, "black_prismarine", 0x2b1225, NONE).asDust();                                                                                                        
    //Igneous 
    public static Material Red_Komatiite = new Material(Ref.ID, "red_komatiite", 0xbf3a11, NONE).asDust().add(Olivine, 1, /*MgCO3, 4, */Flint, 6, DarkAsh, 3);
    public static Material Green_Komatiite = new Material(Ref.ID, "green_komatiite", 0xc0cc64, NONE).asDust().add(Olivine, 4, /*MgCO3, 2, */Flint, 6, DarkAsh, 3);
    public static Material Carbonaite = new Material(Ref.ID, "carbonaite", 0x2d2e26, NONE).asDust().add(Olivine, 2, /*MgCO3, 2, */Calcite, 6, Magnetite, 3);
    public static Material Kimberlite = new Material(Ref.ID, "kimberlite", 0x64460a, NONE).asDust();
    public static Material Pegmatite = new Material(Ref.ID, "pegmatite", 0xf0e8b9, NONE).asDust();
    public static Material Pumice = new Material(Ref.ID, "pumice", 0xfae4e1, NONE).asDust();                                                                                                     
    public static Material Latite = new Material(Ref.ID, "latite", 0xba5b5b, NONE).asDust();                                                                                                                                                                                 
    //Metamorphic Minerals                                                                                                  
    public static Material Gneiss = new Material(Ref.ID, "gneiss", 0x918f8e, NONE).asDust();
    public static Material Migmatite = new Material(Ref.ID, "migmatite", 0x4f4b4a, NONE).asDust();                                                                                                     
    public static Material Amphibolite = new Material(Ref.ID, "amphibolite", 0xd2d4ba, NONE).asDust();                                                                                                        
    ...
    public static Material Skarn = new Material(Ref.ID, "skarn", 0x8a837c, NONE).asDust().add(Calcite, 1);                                                                                                     
    public static Material Slate = new Material(Ref.ID, "slate", 0x737373, NONE).asDust();                                                                                                      
    public static Material Eclogite = new Material(Ref.ID, "eclogite", 0x91d180, NONE).asDust();                                                                                                      
    public static Material Serpentite = new Material(Ref.ID, "serpentite", 0x5de637, NONE).asDust();
    public static Material Slate = new Material(Ref.ID, "granulite", 0xd6c0b2, NONE).asDust();     
    ...
    public static Material Orange_Limestone = new Material(Ref.ID, "orange_limestone", 0xe8965f, SEDIMENT, SEDIMENTSAND).asDust().add(Calcite, 1);                                                                                                      
    ...
    public static Material Breccia = new Material(Ref.ID, "Breccia", 0x999385, SEDIMENT).asDust(); //Angular crystals
    public static Material Conglomerate = new Material(Ref.ID, "Conglomerate", 0xe6c882, SEDIMENT).asDust(); //Circular crystals                                                                                                     
    public static Material Shale = new Material(Ref.ID, "Shale", 0xa6a6a6, SEDIMENT).asDust();
